...
# Путь к данным
data_path = 'D:/heuristic_extractor/labeled.csv'

# Путь к Stockfish
stockfish_path = 'D:/heuristic_extractor/stockfish.exe'

# Директория для сохранения весов
weight_dir = 'D:/heuristic_extractor/board2vec/experiments/experiment_02/weights/'